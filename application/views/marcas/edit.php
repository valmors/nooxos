                     ...
                     <!-- Card Header barra cinza acima do formulário
                        ...
                        <div class="card-body">
                         <!-- FORMULÁRIO-->
                            ...
                            <p><i class="fas fa-clock"></i>&nbsp<?php echo formata_data_banco_com_hora($marcas->marca_data_alteracao); ?>&nbsp<strong>Ultima Atualização</strong></p>
                            <fieldset class="mt-0 border p-2">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        <label>Marca</label>
                                        <input type="text" class="form-control" name="marca_nome" placeholder="Digite a Marca" value="<?php echo $marcas->marca_nome; ?>" > 
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select class="form-control" name="marca_ativa">
                                            <option value="0" <?php echo ($marcas->marca_ativa == 0) ? 'selected' : ''; ?> >Inativo</option>
                                            <option value="1" <?php echo ($marcas->marca_ativa == 1) ? 'selected' : ''; ?>>Ativo</option>
                                        </select>
                                    </div>                                                    
                                </div>
