                     ...
                     <!-- Card Header barra cinza acima do formulário
                        ...
                        <div class="card-body">
                         <!-- FORMULÁRIO-->
                            ...
                            <p><i class="fas fa-clock"></i>&nbsp<?php echo formata_data_banco_com_hora($produtos->produto_data_alteracao); ?>&nbsp<strong>Ultima Atualização</strong></p>
                            <fieldset class="mt-0 border p-2">                               
                                ...
                                <div class="form-group row">
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control" name="produto_codigo" value="<?php echo $produtos->produto_codigo; ?>" > 
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text"  class="form-control" name="produto_descricao" placeholder="Digite o Produto" value="<?php echo $produtos->produto_descricao; ?>" > 
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-control" name="produto_categoria_id">
                                            ...
                                            <option value="<?php echo $categoria->categoria_id; ?>" <?php echo ($categoria->categoria_id == $produtos->produto_categoria_id ? 'selected': ''); ?> <?php echo ($categoria->categoria_ativa == 0 ? 'disabled' : ''); ?>><?php echo ($categoria->categoria_ativa == 1 ? $categoria->categoria_nome.'' : $categoria->categoria_nome.'&nbsp>>INATIVO<<');  ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>  
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-control" name="produto_marca_id">
                                            ...
                                            <option value="<?php echo $marca->marca_id; ?>" <?php echo ($marca->marca_id == $produtos->produto_marca_id ? 'selected': '');?> <?php echo ($marca->marca_ativa == 0 ? 'disabled' : ''); ?> ><?php echo ($marca->marca_ativa == 1 ? $marca->marca_nome.'' : $marca->marca_nome.'&nbsp>>INATIVO<<');  ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>  
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" name="produto_fornecedor_id">
                                            ...
                                            <option value="<?php echo $fornecedor->fornecedor_id; ?>" <?php echo ($fornecedor->fornecedor_id == $produtos->produto_fornecedor_id ? 'selected': ''); ?> <?php echo ($fornecedor->fornecedor_ativo == 0 ? 'disabled' : ''); ?>><?php echo ($fornecedor->fornecedor_ativo == 1 ? $fornecedor->fornecedor_razao.'' : $fornecedor->fornecedor_razao.'&nbsp>>INATIVO<<');  ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>                                      
                                </div>   
                            ...
                            <fieldset class="mt-0 border p-2">                               
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                      ...
                                      <div class="input-group">  
                                        ...
                                        <input type="text" class="form-control money" name="produto_preco_custo" placeholder="Digite o valor" value="<?php echo $produtos->produto_preco_custo; ?>" >                                     
                                    ...
                                    <div class="col-md-2">
                                      ...
                                      <div class="input-group">  
                                        <span class="input-group-text">R$</span>
                                        <input type="text" class="form-control money" name="produto_preco_venda" placeholder="Digite o valor" value="<?php echo $produtos->produto_preco_venda; ?>" >                                     
                                    ...
                                    <div class="col-md-3">
                                      ...
                                      <div class="input-group">  
                                        ...
                                        <input type="number" class="form-control" name="produto_estoque_minimo" placeholder="Qtd Mínima" value="<?php echo $produtos->produto_estoque_minimo; ?>" >                                     
                                    ...
                                    <div class="col-md-3">
                                      ...
                                      <div class="input-group">  
                                        <span class="input-group-text"><i class="fas fa-layer-group"></i></span>
                                        <input type="number" class="form-control" name="produto_qtde_estoque" placeholder="Qtd Estoque" value="<?php echo $produtos->produto_qtde_estoque; ?>" >                                     
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select class="form-control" name="produto_ativo">
                                            <option value="0" <?php echo ($produtos->produto_ativo == 0) ? 'selected' : ''; ?>>Inativo</option>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" name="produto_obs"><?php echo $produtos->produto_obs; ?></textarea>
