                         ...
                         <!-- FORMULÁRIO-->
                            ...
                            <fieldset class="mt-0 border p-2">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        <label>Serviço</label>
                                        <input type="text" class="form-control" name="servico_nome" placeholder="Digite o Serviço" value="<?php echo set_value('servico_nome'); ?>" > 
                                        <?php echo form_error('servico_nome', '<small class="form-text text-danger"><i class="fas fa-exclamation-triangle"></i>&nbsp', '</small>'); ?> 
                                    </div>
                                    <div class="col-md-2">
                                        <label>Preço</label>
                                        <input type="text" class="form-control money" name="servico_preco" placeholder="Digite o valor" value="<?php echo set_value('servico_preco'); ?>" > 
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                           ...
                                           <textarea class="form-control" name="servico_descricao"><?php echo set_value('servico_descricao') ?></textarea> 
