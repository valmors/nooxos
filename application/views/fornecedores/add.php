                         ...
                         <!-- FORMULÁRIO-->
                            ...
                            <fieldset class="mt-0 border p-2">
                                ...
                                <div class="form-grupo row">
                                    <div class="col-md-3">
                                        <label>CNPJ</label>
                                        <input type="text" class="form-control cnpj" id="cnpj" name="fornecedor_cnpj" placeholder="Digite o CNPJ" value="<?php echo set_value('fornecedor_cnpj'); ?>" > 
                                        <?php echo form_error('fornecedor_cnpj', '<small class="form-text text-danger"><i class="fas fa-exclamation-triangle"></i>&nbsp', '</small>'); ?>                                        
                                    </div>    

                                    <div class="col-md-3">
                                        <label>IE</label>
                                        <input type="text" class="form-control" name="fornecedor_ie" placeholder="Digite o IE" value="<?php echo set_value('fornecedor_ie'); ?>" > 
                                        <?php echo form_error('fornecedor_ie', '<small class="form-text text-danger"><i class="fas fa-exclamation-triangle"></i>&nbsp', '</small>'); ?>                                        
                                    </div> 
                                    <div class="col-md-6">
                                        <label>Email</label>
                                        <input type="email" class="form-control" id="email" name="fornecedor_email" placeholder="Email" value="<?php echo set_value('fornecedor_email'); ?>" > 
                                ...
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="razao" name="fornecedor_razao" placeholder="Digite a Razão Social" value="<?php echo set_value('fornecedor_razao'); ?>" > 
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <input type="text" class="form-control" id="nfantasia" name="fornecedor_nome_fantasia" placeholder="Digite o Nome Fantasia" value="<?php echo set_value('fornecedor_nome_fantasia'); ?>" > 
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="textdate" class="form-control" id="abertura" name="fornecedor_data_abertura" placeholder="Data de Abertura" value="<?php echo set_value('fornecedor_data_abertura'); ?>" > 
                                ...
                                <div class="form-group row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control tel" id="telefone" name="fornecedor_telefone" placeholder="Telefone"  value="<?php echo set_value('fornecedor_telefone'); ?>" > 
                                    ...
                                    <div class="col-md-3">
                                        <label>Celular</label>
                                        <input type="text" class="form-control cel" name="fornecedor_celular" placeholder="Celular"  value="<?php echo set_value('fornecedor_celular'); ?>" > 
                            ...
                            <div class="col-md-2">
                                    <label>CEP</label>
                                    <input type="text" class="form-control cep" id="cep" name="fornecedor_cep" placeholder="CEP" value="<?php echo set_value('fornecedor_cep'); ?>" > 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="rua" name="fornecedor_endereco" placeholder="Endereço" value="<?php echo set_value('fornecedor_endereco'); ?>" > 
                                ...
                                <div class="col-md-4">
                                    <label>Bairro</label>
                                    <input type="text" class="form-control" id="bairro" name="fornecedor_bairro" placeholder="Bairro" value="<?php echo set_value('fornecedor_bairro'); ?>" > 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <label>Número</label>
                                    <input type="text" class="form-control" id="numero"  name="fornecedor_numero_endereco" placeholder="Número" value="<?php echo set_value('fornecedor_numero_endereco'); ?>" > 
                                ...
                                <div class="col-md-2">
                                    <label>Estado</label>
                                    <input type="text" class="form-control"  id="uf" name="fornecedor_estado" placeholder="UF" value="<?php echo set_value('fornecedor_estado'); ?>" > 
                            ...
                            <fieldset class="mt-2 mb-2 border p-2">
                                ...
                                <div class="col-md-10">
                                       <label>Observações</label>
                                        <textarea class="form-control" name="fornecedor_obs"><?php echo set_value('fornecedor_obs'); ?></textarea> 
