                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                         <i class="fas fa-calendar-alt"></i>&nbspData Atual&nbsp  <?php echo date('Y-m-d H:i:s');?> <a title="Cadastrar nova Conta" href="<?php echo base_url('receber/add'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-plus-circle"></i>&nbspNova</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach ($contas_receber as $conta): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>R$<?php echo $conta->conta_receber_valor; ?></td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#pagar-<?php echo $conta->conta_receber_id; ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                                                
                                            </td>
                                        </tr>
                                        
                                        <!-- DELETAR Modal-->
                                        <div class="modal fade" id="receber-<?php echo $conta->conta_receber_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                            aria-hidden="true">
