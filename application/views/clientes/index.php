                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a title="Cadastrar novo Cliente" href="<?php echo base_url('clientes/add'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-plus-circle"></i>&nbspNovo</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach ($clientes as $cliente): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ($cliente->cliente_tipo == 1) ? 'Pessoa Fisica' : 'Pessoa Juridica'; ?> 
                                            </td>
                                            <td><?php echo ($cliente->cliente_ativo == 1) ? '<span class="badge badge-info">Ativo</span>' : '<span class="badge badge-warning">Inativo</span>'; ?></td>
                                            <td class="text-right">
                                                <a title="Editar" href="<?php echo base_url('clientes/edit/'.$cliente->cliente_id); ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                                        ...
                                        <div class="modal fade" id="cliente-<?php echo $cliente->cliente_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">Para execluir o cliente clique <strong>SIM!</strong>.</div>
