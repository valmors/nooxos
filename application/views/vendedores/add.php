                         ...
                         <!-- FORMULÁRIO-->
                            ...
                            <fieldset class="mt-0 border p-2">
                                ...
                                <legend class="form-control">
                                    <i class="fas fa-user-tag"></i>&nbspCadastrar Vendedor - Matrícula&nbsp<strong><?php echo $vendedor_codigo; ?></strong>
                                </legend>
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <label>Nome Completo</label>
                                        <input type="text" class="form-control" name="vendedor_nome_completo" placeholder="Digite o Nome Completo" value="<?php echo set_value('vendedor_nome_completo'); ?>" > 
                                    ...
                                    <div class="col-md-3">
                                        <label>CPF</label>
                                        <input type="text" class="form-control cpf" name="vendedor_cpf" placeholder="Digite o CPF" value="<?php echo set_value('vendedor_cpf'); ?>" > 
                                        <?php echo form_error('vendedor_cpf', '<small class="form-text text-danger"><i class="fas fa-exclamation-triangle"></i>&nbsp', '</small>'); ?>                                        
                                    </div>    

                                    <div class="col-md-3">
                                        <label>RG</label>
                                        <input type="text" class="form-control rg" name="vendedor_rg" placeholder="Digite o RG" value="<?php echo set_value('vendedor_rg'); ?>" > 
                                ...
                                <div class="form-grupo row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control tel" id="telefone" name="vendedor_telefone" placeholder="Telefone"  value="<?php echo set_value('vendedor_telefone'); ?>" > 
                                        <?php echo form_error('vendedor_telefone', '<small class="form-text text-danger"><i class="fas fa-exclamation-triangle"></i>&nbsp', '</small>'); ?>
                                    </div>
        
                                    <div class="col-md-3">
                                        <label>Celular</label>
                                        <input type="text" class="form-control cel" name="vendedor_celular" placeholder="Celular"  value="<?php echo set_value('vendedor_celular'); ?>" > 
                            ...
                            <div class="col-md-2">
                                    <label>CEP</label>
                                    <input type="text" class="form-control cep" id="cep" name="vendedor_cep" placeholder="CEP" value="<?php echo set_value('vendedor_cep'); ?>" > 
                                    <?php echo form_error('vendedor_cep', '<small class="form-text text-danger"><i class="fas fa-exclamation-triangle"></i>&nbsp', '</small>'); ?>
                                </div>   

                                <div class="col-md-6">
                                    <label>Endereço</label>
                                    <input type="text" class="form-control" id="rua" name="vendedor_endereco" placeholder="Endereço" value="<?php echo set_value('vendedor_endereco'); ?>" > 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <label>Número</label>
                                    <input type="text" class="form-control" id="numero"  name="vendedor_numero_endereco" placeholder="Número" value="<?php echo set_value('vendedor_numero_endereco'); ?>" > 
                                ...
                                <div class="col-md-3">
                                    <label>Cidade</label>
                                    <input type="text" class="form-control" id="cidade" name="vendedor_cidade" placeholder="Cidade" value="<?php echo set_value('vendedor_cidade'); ?>" > 
                                    <?php echo form_error('vendedor_cidade', '<small class="form-text text-danger"><i class="fas fa-exclamation-triangle"></i>&nbsp', '</small>'); ?>
                                </div>   

                                <div class="col-md-2">
                                    <label>Estado</label>
                                    <input type="text" class="form-control"  id="uf" name="vendedor_estado" placeholder="UF" value="<?php echo set_value('vendedor_estado'); ?>" > 
                            ...
                            <fieldset class="mt-2 mb-2 border p-2">
                                ...
                                <div class="col-md-10">
                                       <label>Observações</label>
                                        <textarea class="form-control" name="vendedor_obs"><?php echo set_value('vendedor_obs'); ?></textarea> 
                            ...
                            <input type="hidden" name="vendedor_codigo" value="<?php echo $vendedor_codigo; ?>" > 
