                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a title="Cadastrar nova Categoria" href="<?php echo base_url('categorias/add'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-plus-circle"></i>&nbspNovo</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach ($categorias as $categoria): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ($categoria->categoria_ativa == 1) ? '<span class="badge badge-info">Ativa</span>' : '<span class="badge badge-warning">Inativa</span>'; ?></td>
                                            <td class="text-right">
                                                ...
                                                <a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#cliente-<?php echo $categoria->categoria_id; ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                                                
                                            </td>
                                        </tr>
                                        <!-- Logout Modal-->
                                        <div class="modal fade" id="cliente-<?php echo $categoria->categoria_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                            aria-hidden="true">
